...
from utils.types import WorkflowState, Status, EventCallback, sse_headers
...
async def orchestrate_workflows(run_id: str, payload: Dict, updateCallback: EventCallback):
    ...
    state = WorkflowState(
        ...
        context={"user_input": user_input}, # just have the first entry in the conversation at the moment
        memory={"conversation_context": conversation_context,
